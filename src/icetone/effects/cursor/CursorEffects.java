 ...
 */
package icetone.effects.cursor;
...
import icetone.controls.extras.emitter.AlphaInfluencer;
import icetone.controls.extras.emitter.ColorInfluencer;
import icetone.controls.extras.emitter.DirectionInfluencer;
import icetone.controls.extras.emitter.ElementEmitter;
import icetone.controls.extras.emitter.GravityInfluencer;
import icetone.controls.extras.emitter.ImpulseInfluencer;
import icetone.controls.extras.emitter.RotationInfluencer;
import icetone.controls.extras.emitter.SizeInfluencer;
import icetone.controls.extras.emitter.SpriteInfluencer;
...
public class CursorEffects {
	...
	public CursorEffects(Screen screen) {
		...
		cursorEmitter.setSprite("icetone/style/def/Common/Particles/core.png", 3, 3, 8);
