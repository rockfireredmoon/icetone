...
public class Password extends TextField {
	...
	public Password(ElementManager screen) {
		this(screen, UIDUtil.getUID(), Vector2f.ZERO, LUtil.LAYOUT_SIZE, screen.getStyle("TextField").getVector4f("resizeBorders"),
				screen.getStyle("TextField").getString("defaultImg"));
	}

	public Password(ElementManager screen, Vector2f position) {
		this(screen, UIDUtil.getUID(), position, LUtil.LAYOUT_SIZE, screen.getStyle("TextField").getVector4f("resizeBorders"),
				screen.getStyle("TextField").getString("defaultImg"));
	}
	...
	public Password(ElementManager screen, String UID, Vector2f position) {
		this(screen, UID, position, LUtil.LAYOUT_SIZE, screen.getStyle("TextField").getVector4f("resizeBorders"),
				screen.getStyle("TextField").getString("defaultImg"));
	}
	...
	public Password(ElementManager screen, String UID, Vector2f position, Vector2f dimensions, Vector4f resizeBorders,
			String defaultImg) {
