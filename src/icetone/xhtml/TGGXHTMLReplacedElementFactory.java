...
public class TGGXHTMLReplacedElementFactory extends TGGReplacedElementFactory {
    ...
    public TGGXHTMLReplacedElementFactory(TGGRenderer renderer) {
    ...
    public ReplacedElement createReplacedElement(LayoutContext c, BlockBox box,
        ...
        if (replacedElement == null
            ...
            if (replacedElement != null) {
                if (replacedElement instanceof TGGFormControlReplacementElement) {
                    ((TGGFormControlReplacementElement) replacedElement).calculateSize(c, box
            ...
            TGGFormControlReplacementElement fcre = new TGGFormControlReplacementElement(
