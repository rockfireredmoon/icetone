...
public class KeyboardUIEvent extends KeyInputEvent implements UIEvent {
	...
	public boolean isRepeating() {
		return repeating || super.isRepeating();
	}

	public KeyboardUIEvent setRepeating() {
		repeating = true;
		return this;
	}
	...
	public boolean isSameKey(KeyboardUIEvent last) {
		return getKeyChar() == last.getKeyChar() && getKeyCode() == last.getKeyCode()
				&& getModifiers() == last.getModifiers();
	}
